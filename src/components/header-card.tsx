export function HeaderCard({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative overflow-hidden rounded-xl bg-blue-500 px-2 py-12 lg:px-14">
      {/* Decorative circles */}
...
export function HeaderCardHeading({ children }: { children: React.ReactNode }) {
  return (
    <h1 className="font-heading text-4xl leading-[1.05] font-black tracking-tight text-white md:text-5xl lg:text-6xl">
      {children}
    </h1>
  );
}
